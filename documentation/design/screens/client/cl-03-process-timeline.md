...
- **Abas**: Alternar entre "Timeline", "Resumo" e "Documentos".
- **Corpo**:
  - Aba "Timeline": Timeline vertical com linha conectando os círculos (eventos).
  - Aba "Resumo": Informações e status gerais do processo.
  - Aba "Documentos": Lista de anexos do processo.
...
| Resumo | `LegalProcess.description` | - |
| Documentos | `LegalProcess.documents` | - |

## 🕹️ Ações
- **Compartilhar**: Gerar um PDF resumido da timeline (Opcional).
- **Dúvida sobre este evento**: Na aba timeline, botão que leva ao WhatsApp pré-preenchido com o ID do processo.
