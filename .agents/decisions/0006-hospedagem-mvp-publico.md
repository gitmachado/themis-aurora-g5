...
## Status
Aceito, parcialmente superado pela ADR 0008 para storage de documentos

## Nota de atualizacao
Em 2026-04-28, a ADR 0008 substituiu a decisao de manter documentos em volume local no deploy publico. A topologia de VM unica, proxy HTTPS, backend em container e PostgreSQL sem exposicao publica continua valida; apenas o armazenamento de binarios passa a usar Supabase Storage privado.
