...
CHECK (type IN (
  'NEW_LEAD', 'STATUS_CHANGED', 'DOCUMENT_SENT', 'HUMAN_SUPPORT',
  'DOCUMENT_REQUESTED', 'NEW_NOTE', 'APPOINTMENT_SCHEDULED', 'APPOINTMENT_CHANGED',
  'APPOINTMENT_PENDING', 'NEW_APPOINTMENT_AI', 'DEADLINE_WARNING'
));
